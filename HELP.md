...
* The original package name 'com.example.spring-boot2-webclient-sync-example' is invalid and this project uses 'com.example.springboot2webclientsyncexample' instead.
